...
//        holder.txtLike.setText(vm.getLike());
//        holder.txtDislike.setText(vm.getDislike());
//        holder.txtKomen.setText(vm.getComvid());
                                        ...
                                        new android.app.AlertDialog.Builder(context)
                                                ...
                                                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                                    public void onClick(DialogInterface dialog, int id) {
                                                        ...
                                                        apiService.hapusVideo(vm.getVideoId()).enqueue(new Callback<ResponseBody>() {
                                                            @Override
