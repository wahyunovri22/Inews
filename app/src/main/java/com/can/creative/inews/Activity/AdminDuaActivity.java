...
public class AdminDuaActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_dua);
    ...
    public final Runnable runnable = new Runnable() {
        ...
        public void run() {
            ...
            Picasso.with(getApplicationContext())
                    ...
                    .error(R.drawable.no_image_found)
                    .into(imgDepan);
            AdminDuaActivity.this.handler.postDelayed(runnable, 2000);
        }
    };
}
